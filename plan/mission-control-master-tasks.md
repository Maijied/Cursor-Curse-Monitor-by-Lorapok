...
| LOGS-01 | **Unified logs explorer** — structured JSON logs, severity, source, ACL filter, full-text search, time range, export; D1 + KV scatter | **PR** | Filters + CSV + meta expand; [#168](https://github.com/Maijied/Cursor-Curse-Monitor-by-Lorapok/issues/168) |
