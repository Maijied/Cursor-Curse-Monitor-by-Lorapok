...
- **Post–v1.0.16 restore** — README live download badges/chart, readme-stats generation pipeline, mail relay repair script, fail-closed mail verify in CI, and `/api/health` mail status fields (`relayBound`, `restConfigured`)
