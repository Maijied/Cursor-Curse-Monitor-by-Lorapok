  ...
  dataFlow: {
    ...
    rows: [
      ...
      [
        ...
        { id: "r2", label: "STATS_R2", sub: "Mail + stats objects", icon: "database", tone: "purple" },
    ...
    simulationPath: ["ide", "ext", "scan", "api", "db", "alert", "visitor", "site", "operator", "mc", "fn", "kv", "r2"],
  },

  deployPipeline: {
    label: "Production Deployment",
    ariaLabel:
      "Production deployment: every ci-cd.yml job from resolve-version through marketplaces, Cloudflare, social gallery, and Discord notify",
    rows: [
      [
        { id: "pushmain", label: "Push to main", sub: "CI + Pages", icon: "git", tone: "blue" },
        { id: "pr", label: "Pull request", sub: "CI only", icon: "git", tone: "teal" },
        ...
        { id: "mcinfra", label: "deploy-infra", sub: "Admin + site + mail", icon: "server", tone: "teal" },
        { id: "mctag", label: "publish-tag / full-release", sub: "Marketplace push", icon: "package", tone: "green" },
      ],
      [
        { id: "resolveversion", label: "resolve-version", sub: "Live marketplaces", icon: "brain", tone: "teal" },
        { id: "validatedispatch", label: "validate-dispatch", sub: "Tag policy gate", icon: "clipboard", tone: "amber" },
        { id: "admingate", label: "admin-deploy-gate", sub: "Infra gate", icon: "lock", tone: "purple" },
      ],
      [
        { id: "ci", label: "ci", sub: "Compile, test, VSIX", icon: "clipboard", tone: "purple" },
        { id: "browserextci", label: "browser-extension-ci", sub: "Firefox + Chrome", icon: "puzzle", tone: "purple" },
        { id: "adminci", label: "admin-ci", sub: "Mission Control tests", icon: "rocket", tone: "blue" },
        { id: "cisummary", label: "ci-summary", sub: "Test Results Summary", icon: "chart", tone: "teal" },
      ],
      [
        { id: "tagprep", label: "prepare-tag-on-push", sub: "Max live + patch", icon: "brain", tone: "teal" },
        { id: "releaseprep", label: "release-prep", sub: "version:sync", icon: "refresh", tone: "teal" },
      ],
      [
        { id: "market", label: "deploy", sub: "OVSX · VS Code · AMO · Chrome", icon: "package", tone: "green" },
        { id: "adminjob", label: "admin-deploy", sub: "Cloudflare Pages", icon: "rocket", tone: "blue" },
        { id: "webjob", label: "website", sub: "GitHub Pages", icon: "globe", tone: "teal" },
        { id: "seojob", label: "seo-pipeline", sub: "site-data + SEO PR", icon: "chart", tone: "purple" },
      ],
      [
        { id: "socialqueue", label: "queue-social-gallery", sub: "DEPLOY-03", icon: "send", tone: "green" },
        { id: "webdiscord", label: "website-discord-notify", sub: "Marketing card", icon: "message", tone: "teal" },
      ],
      [
    ...
    edges: [
      { from: "pushmain", to: "resolveversion" },
      { from: "pr", to: "resolveversion" },
      { from: "resolveversion", to: "ci" },
      { from: "resolveversion", to: "browserextci" },
      { from: "resolveversion", to: "adminci" },
      { from: "ci", to: "cisummary" },
      { from: "browserextci", to: "cisummary" },
      { from: "adminci", to: "cisummary" },
      { from: "pushmain", to: "tagprep" },
      { from: "tagprep", to: "releaseprep" },
      { from: "mctag", to: "validatedispatch" },
      { from: "mcdeploy", to: "validatedispatch" },
      { from: "mcrollback", to: "validatedispatch" },
      { from: "validatedispatch", to: "releaseprep" },
      { from: "releaseprep", to: "market" },
      { from: "mcinfra", to: "admingate" },
      { from: "admingate", to: "adminjob" },
      { from: "mcinfra", to: "webjob" },
      { from: "pushmain", to: "adminjob" },
      { from: "pushmain", to: "webjob" },
      { from: "market", to: "ovsx" },
      ...
      { from: "webjob", to: "webdiscord" },
      { from: "webdiscord", to: "discordn" },
    ...
    sidebar: {
      title: "ci-cd.yml jobs",
      items: [
        "resolve-version",
        "ci · browser-extension-ci · admin-ci",
        "release-prep · deploy",
        "admin-deploy · website",
        "queue-social-gallery",
        "website-discord-notify",
      ],
    },
    simulationPath: [
      "pushmain",
  ...
  scheduledOps: {
    ...
    rows: [
      [
        ...
        { id: "discordcfg", label: "Discord webhooks · deploy · github-log · community", sub: "Settings KV slots", icon: "message", tone: "purple" },
