...
export const API_CATALOG: ApiCatalogEntry[] = [
  ...
  { id: "discord-config-put", path: "/integrations/discord/config", method: "PUT", auth: "admin", group: "Integrations", description: "Save Discord deployment-status webhook URL" },
