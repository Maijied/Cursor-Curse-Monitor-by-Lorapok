...
export const API_CATALOG: ApiCatalogEntry[] = [
  ...
  { id: "site-config", path: "/site-config", method: "GET", auth: "public", group: "Public", description: "Public subscribe, mail, and reindex policy (no secrets)", safeProbe: true },
  ...
  { id: "reindex-config", path: "/integrations/reindex/config", method: "GET", auth: "admin", group: "Integrations", description: "Conversation reindex write policy for IDE extension", safeProbe: true },
  { id: "reindex-config-put", path: "/integrations/reindex/config", method: "PUT", auth: "admin", group: "Integrations", description: "Save reindex enabled flag and live vs quit-first policy" },
