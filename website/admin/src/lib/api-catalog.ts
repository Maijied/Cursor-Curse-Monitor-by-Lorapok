...
export const API_CATALOG: ApiCatalogEntry[] = [
  ...
  { id: "retry-failed-mail-cron", path: "/cron/retry-failed-mail", method: "POST", auth: "cron", group: "Integrations", description: "Cron hook to resend failed outbound mailbox messages (CRON_SECRET)" },
