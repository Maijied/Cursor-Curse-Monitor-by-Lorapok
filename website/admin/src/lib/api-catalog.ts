...
export const API_CATALOG: ApiCatalogEntry[] = [
  ...
  { id: "discord-config", path: "/integrations/discord/config", method: "GET", auth: "admin", description: "Discord deployment webhook settings", safeProbe: true },
  {
    id: "discord-test",
    path: "/integrations/discord/test",
    method: "POST",
    auth: "admin",
    description: "Send a Discord webhook test message",
  },
