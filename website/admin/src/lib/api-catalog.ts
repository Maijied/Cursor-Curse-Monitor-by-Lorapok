...
export const API_CATALOG: ApiCatalogEntry[] = [
  ...
  { id: "firebase-config-put", path: "/integrations/firebase/config", method: "PUT", auth: "admin", group: "Integrations", description: "Save Firebase settings and sync VITE_FIREBASE_* GitHub secrets" },
  { id: "github-config", path: "/integrations/github/config", method: "GET", auth: "admin", group: "Integrations", description: "GitHub repo and Actions secrets environment", safeProbe: true },
  ...
  { id: "testmail-config-put", path: "/integrations/testmail/config", method: "PUT", auth: "admin", group: "Integrations", description: "Save testmail settings and sync TESTMAIL_* GitHub secrets" },
  ...
  { id: "mail-aliases-list", path: "/mail/aliases", method: "GET", auth: "admin", group: "Integrations", description: "List @lorapok.tech mail aliases (master)", safeProbe: true },
  { id: "mail-aliases-create", path: "/mail/aliases", method: "POST", auth: "admin", group: "Integrations", description: "Create mail alias with routing + optional login" },
  { id: "mail-aliases-update", path: "/mail/aliases", method: "PUT", auth: "admin", group: "Integrations", description: "Update mail alias metadata or auth login" },
  { id: "mail-aliases-delete", path: "/mail/aliases?localPart=example", method: "DELETE", auth: "admin", group: "Integrations", description: "Delete custom mail alias (master)" },
