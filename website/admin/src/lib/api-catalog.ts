...
export const API_CATALOG: ApiCatalogEntry[] = [
  ...
  { id: "mail-deliverability", path: "/integrations/mail/deliverability", method: "GET", auth: "admin", group: "Integrations", description: "Mail deliverability audit matrix (MAIL-16)", safeProbe: true },
  { id: "mail-deliverability-run", path: "/integrations/mail/deliverability", method: "POST", auth: "admin", group: "Integrations", description: "Run mail deliverability audit on demand" },
  { id: "github-webhook", path: "/webhooks/github", method: "POST", auth: "public", group: "Integrations", description: "GitHub repo webhook ingest with HMAC verify (GH-06)" },
  ...
  { id: "social-gallery", path: "/integrations/social/gallery", method: "GET", auth: "admin", group: "Integrations", description: "Deploy social gallery jobs (SOCIAL-02)", safeProbe: true },
  { id: "social-gallery-item", path: "/integrations/social/gallery/item", method: "PUT", auth: "admin", group: "Integrations", description: "Edit social gallery caption/hashtags" },
  ...
  { id: "mail-deliverability-cron", path: "/cron/mail-deliverability", method: "POST", auth: "cron", group: "Integrations", description: "Cron hook for mail deliverability audit (CRON_SECRET)" },
