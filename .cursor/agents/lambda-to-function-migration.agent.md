---
description: Custom agent for migrating AWS Lambda to Azure Function
name: LambdaToFunctionMigration
...
This agent is designed to assist users in migrating from AWS Lambda to Azure Functions. The process includes:
...
## Usage
To use this agent, you can either:
...
1. **Assessment**
    ...
    - **Assessment Report Generation**
        ...
        - Provide a side by side comparison of AWS Lambda and Azure Functions project structure. Use the `get_azure_bestpractices` tool to learn about the best practices for Azure Functions code generation project structure.
...
2. **Migration**
    ...
    **Learn how to migrate AWS Lambda code and infrastructure to Azure Functions:**
    ...
    - Learn Azure Functions best practices for code generation and deployment strategies using #tool:azure-mcp/get_azure_bestpractices.
...
3. **Validation**
    ...
    - Ensure compatibility with Azure Functions runtime and code generation best practices mentioned in `get_azure_bestpractices` tool
