...
name: seo
description: >-
  Audit and optimize SEO, sitemap, structured data, and marketplace discoverability
  for Cursor Curse Monitor. Use when the user invokes /seo or asks to improve reach,
  search ranking, meta tags, Open Graph, or extension marketplace visibility.
---

# SEO — Reach & Discoverability

Optimize the project website, GitHub Pages, and marketplace listings so users can find **Cursor Curse Monitor by Lorapok** everywhere they search.
...
| GitHub | `https://github.com/Maijied/Cursor-Curse-Monitor-by-Lorapok` |
...
Checklist file: `.cursor/skills/seo/checklist.md`
